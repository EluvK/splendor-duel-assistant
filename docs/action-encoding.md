...
## 二、状态特征张量布局 (Total: 915 Float32)

全局状态由 5 大特征分块组成，展平总维度为 **915 维**：

```
[0..225]    分块 1: 5×5 棋盘空间 (9 通道 × 25 格 = 225 维)
[225..621]  分块 2: 金字塔市场可见卡牌 (12 真实槽位 × 33 维 = 396 维)
[621..625]  分块 3: 场上王室卡 (4 维布尔向量)
[625..871]  分块 4: 双方玩家状态仪表板 (2 玩家 × 123 维 = 246 维)
[871..915]  分块 5: 全局环境、博弈差值与胜负威胁 (44 维)
```
...
- `[24..123]`: 预留手牌 (3 槽位 × 33 维 = 99 维，结构同卡牌槽位；对手暗牌仅暴露 present 与 tier)
