...
fn test_reserved_cards_anti_leakage_and_encoding() {
    ...
    // P1 (对手) 槽位 0 (盲抽暗牌): [772..805]
    // 必须掩蔽私有信息，但保留公开的 present 与 tier (M4 POMDP 设计)
    let p1_slot0 = &obs[772..805];
    ...
    // 特征 41: op_has_winning_purchase [871 + 41 = 912]
